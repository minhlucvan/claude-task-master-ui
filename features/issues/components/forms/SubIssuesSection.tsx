...
type SubIssue = IssueDetailsFragment['subIssues'][0];
...
function SubIssueItem({ subIssue, disabled }: SubIssueItemProps) {
   ...
   const handleClick = () => {
      if (!disabled) {
         // Convert SubIssue to the format expected by openPanel
         const issueForPanel = {
            ...subIssue,
            ...
            taskId: null,
            subtaskId: null,
            assigneeId: subIssue.assignee?.id || null,
            projectId: null,
               ...
               <div className="flex items-start gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                     <div className="flex items-center gap-2 mb-1">
                        ...
                        {/* SubIssue doesn't have priority field in GraphQL fragment */}
                     </div>
